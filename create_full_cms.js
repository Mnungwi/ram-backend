...
async function run() {
  try {
    ...
    // 1. website_settings (general keys for stats, slider, about details)
    ...
    `);
    console.log('website_careers table created.');
    ...
    `);
    console.log('website_faqs table created.');
    ...
    console.log('✅ Finished creating and seeding all database CMS tables.');
  } catch (err) {
